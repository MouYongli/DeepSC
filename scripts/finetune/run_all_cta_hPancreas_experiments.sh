...
PYTHONPATH=src torchrun \
  ...
  pretrained_model_path="/home/angli/DeepSC/results/oneOrTwoStreamAttention/pretraining_attention_stream_1/DeepSC_3_0.ckpt" \
...
# Experiment 2: epoch3 + stream2
echo "=========================================="
echo "Experiment 2/4: Cell Type Annotation"
echo "Checkpoint: epoch3 (DeepSC_3_0.ckpt)"
echo "Architecture: Two Stream (attention_stream=2)"
echo "=========================================="
echo "Start time: $(date)"
...
PYTHONPATH=src torchrun \
  ...
  data_path="/home/angli/DeepSC/data/processed/baseline/scgpt/hPancreas_train.h5ad" \
  data_path_eval="/home/angli/DeepSC/data/processed/baseline/scgpt/hPancreas_test.h5ad" \
  pretrained_model_path="/home/angli/DeepSC/results/oneOrTwoStreamAttention/pretraining_attention_stream_2/DeepSC_3_0.ckpt" \
  load_pretrained_model=true \
...
# Experiment 3: latest + stream1
echo "=========================================="
echo "Experiment 3/4: Cell Type Annotation"
echo "Checkpoint: latest (latest_checkpoint.ckpt)"
echo "Architecture: One Stream (attention_stream=1)"
echo "=========================================="
echo "Start time: $(date)"
...
PYTHONPATH=src torchrun \
  ...
  data_path="/home/angli/DeepSC/data/processed/baseline/scgpt/hPancreas_train.h5ad" \
  data_path_eval="/home/angli/DeepSC/data/processed/baseline/scgpt/hPancreas_test.h5ad" \
  pretrained_model_path="/home/angli/DeepSC/results/oneOrTwoStreamAttention/pretraining_attention_stream_1/latest_checkpoint.ckpt" \
  load_pretrained_model=true \
  model.attention_stream=1 \
  model.cross_attention_architecture="A"
...
# Experiment 4: latest + stream2
echo "=========================================="
echo "Experiment 4/4: Cell Type Annotation"
echo "Checkpoint: latest (latest_checkpoint.ckpt)"
echo "Architecture: Two Stream (attention_stream=2)"
echo "=========================================="
echo "Start time: $(date)"
...
PYTHONPATH=src torchrun \
  ...
  data_path="/home/angli/DeepSC/data/processed/baseline/scgpt/hPancreas_train.h5ad" \
  data_path_eval="/home/angli/DeepSC/data/processed/baseline/scgpt/hPancreas_test.h5ad" \
  pretrained_model_path="/home/angli/DeepSC/results/oneOrTwoStreamAttention/pretraining_attention_stream_2/latest_checkpoint.ckpt" \
  load_pretrained_model=true \
  model.attention_stream=2 \
  model.cross_attention_architecture="A"

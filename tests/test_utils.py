...
from src.deepsc.utils.utils import path_of_file, seed_all, setup_logging
...
class TestSeedAll:
    ...
    def test_seed_all_sets_all_seeds(
        self, mock_torch_seed, mock_random_seed, mock_numpy_seed
    ):
    ...
    def test_seed_all_sets_cuda_seed_when_available(
        self, mock_cuda_seed, mock_cuda_available
    ):
